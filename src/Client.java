...
public class Client implements ActionListener {
   ...
   static JFrame j = new JFrame();
    ...
    Client() {
        ...
        URL imgURL4 = getClass().getResource("Minnie_Mouse_Duckipedia.png");
        if (imgURL4 != null) {
        ...
        JLabel usernameLabel = new JLabel("MINNIE");
...
//        p1.add(scrollPane);
    ...
    public static void main(String[] args) {
        ...
        try {
            Socket s = new Socket("127.0.0.1", 5004);
